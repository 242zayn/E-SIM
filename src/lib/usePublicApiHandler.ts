...
// lib/api/
// ├── usePublicApiHandler.ts    // Public APIs (no token)
// ├── useProtectedApiHandler.ts // Protected APIs (with token)
// ├── useApiMutation.ts         // Mutations (public & protected)
// ├── useApiErrorHandler.ts     // Error handler
